...
gdjs.EndScreenCode.asyncCallback12425156 = function (runtimeScene, asyncObjectsList) {
...
gdjs.EndScreenCode.idToCallbackMap.set(12425156, gdjs.EndScreenCode.asyncCallback12425156);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback12425156(runtimeScene, asyncObjectsList)), 12425156, asyncObjectsList);
}
}
...
gdjs.EndScreenCode.asyncCallback12426604 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "ChooseCharacter", false);
}
gdjs.EndScreenCode.localVariables.length = 0;
}
gdjs.EndScreenCode.idToCallbackMap.set(12426604, gdjs.EndScreenCode.asyncCallback12426604);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback12426604(runtimeScene, asyncObjectsList)), 12426604, asyncObjectsList);
}
}
...
gdjs.EndScreenCode.userFunc0xa683a0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xa683a0(runtimeScene);
