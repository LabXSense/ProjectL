...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = ((Number(eventsFunctionContext.getArgument("FlashDuration")) || 0) > 0);
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__Flash__Flash.Flash.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__Flash.Flash.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFlashDuration((Number(eventsFunctionContext.getArgument("FlashDuration")) || 0));
}
}
{for(var i = 0, len = gdjs.evtsExt__Flash__Flash.Flash.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
...
gdjs.evtsExt__Flash__Flash.Flash.prototype.onOwnerRemovedFromSceneContext.idToCallbackMap = new Map();
...
{for(var i = 0, len = gdjs.evtsExt__Flash__Flash.Flash.prototype.onOwnerRemovedFromSceneContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__Flash.Flash.prototype.onOwnerRemovedFromSceneContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).Stop(eventsFunctionContext);
}
}
}
