...
gdjs.evtsExt__StayOnScreen__StayOnScreen.StayOnScreen = class StayOnScreen extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.MarginTop !== undefined)
      this._behaviorData.MarginTop = behaviorOverriding.MarginTop;
    if (behaviorOverriding.MarginBottom !== undefined)
      this._behaviorData.MarginBottom = behaviorOverriding.MarginBottom;
    if (behaviorOverriding.MarginLeft !== undefined)
      this._behaviorData.MarginLeft = behaviorOverriding.MarginLeft;
    if (behaviorOverriding.MarginRight !== undefined)
      this._behaviorData.MarginRight = behaviorOverriding.MarginRight;
...
gdjs.evtsExt__StayOnScreen__StayOnScreen.StayOnScreen.prototype.doStepPostEventsContext.idToCallbackMap = new Map();
