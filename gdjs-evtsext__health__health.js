...
gdjs.evtsExt__Health__Health.Health = class Health extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.IsJustDamaged !== undefined)
      this._behaviorData.IsJustDamaged = behaviorOverriding.IsJustDamaged;
    if (behaviorOverriding.CooldownActive !== undefined)
      this._behaviorData.CooldownActive = behaviorOverriding.CooldownActive;
...
gdjs.evtsExt__Health__Health.Health.prototype.HitContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__Health__Health.Health.prototype.IsDeadContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__Health__Health.Health.prototype.doStepPreEventsContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__Health__Health.Health.prototype.IsJustDamagedContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__Health__Health.Health.prototype.HealContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__Health__Health.Health.prototype.SetHealthContext.idToCallbackMap = new Map();
...
{for(var i = 0, len = gdjs.evtsExt__Health__Health.Health.prototype.SetHealthContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Health__Health.Health.prototype.SetHealthContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setHealth((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}
}
...
gdjs.evtsExt__Health__Health.Health.prototype.HealthContext.idToCallbackMap = new Map();
...
{eventsFunctionContext.returnValue = (( gdjs.evtsExt__Health__Health.Health.prototype.HealthContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__Health__Health.Health.prototype.HealthContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getHealth());}
}
