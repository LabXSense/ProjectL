...
if (typeof gdjs.evtsExt__ArrayTools__GlobalFlatten !== "undefined") {
  gdjs.evtsExt__ArrayTools__GlobalFlatten.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__ArrayTools__GlobalFlatten = {};
gdjs.evtsExt__ArrayTools__GlobalFlatten.idToCallbackMap = new Map();


gdjs.evtsExt__ArrayTools__GlobalFlatten.userFunc0xa2b870 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
/** @type {gdjs.Variable} */
...
gdjs.evtsExt__ArrayTools__GlobalFlatten.eventsList0 = function(runtimeScene, eventsFunctionContext) {

{


gdjs.evtsExt__ArrayTools__GlobalFlatten.userFunc0xa2b870(runtimeScene, eventsFunctionContext);
...
gdjs.evtsExt__ArrayTools__GlobalFlatten.func = function(runtimeScene, Array, Deep, parentEventsFunctionContext) {
...
gdjs.evtsExt__ArrayTools__GlobalFlatten.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__ArrayTools__GlobalFlatten.registeredGdjsCallbacks = [];